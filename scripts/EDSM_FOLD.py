...
def EDSM_Fold(dfa, q1,q2):

	if q2 in dfa.FinalAcceptStates:
		dfa.FinalAcceptStates.add(q1)

	for a in dfa.Alphabet:
		transition_from_q2 = dfa.getTransitionState(q2,a)
		transition_from_q1 = dfa.getTransitionState(q1,a)
		if transition_from_q2 != 0:
			if transition_from_q1 != 0:
				dfa = EDSM_Fold(dfa, transition_from_q1, transition_from_q2)
			else:
				dfa.setTransition(q1, a, transition_from_q2)
				dfa.deleteTransition(q2, a)
	return dfa
